...
function out = SpeedupOptimizationPSO(problem, params)
    ...
    for i=1:nPop
        ...
        % Evaluation
        particle(i).Cost = CostFunction(particle(i).Position, params);
    ...
    for it=1:MaxIt
        ...
        if ShowIterInfo
            disp(['Iteration ' num2str(it) '/' num2str(MaxIt) ': Best Cost = ' num2str(BestCosts(it))]);
        end
